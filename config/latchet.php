...
return [
    ...
    */
    ...
    'socketPort'   => env('LATCHET_SOCKET_PORT', 1111),
    /*
    |--------------------------------------------------------------------------
    | Enable Push Option
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'enablePush'   => env('LATCHET_ENABLE_PUSH', false),
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'zmqPort'      => env('LATCHET_ZMQ_PORT', 5555),
    /*
    |--------------------------------------------------------------------------
    | Allow Flash
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'allowFlash'   => env('LATCHET_ALLOW_FLASH', false),
    /*
    |--------------------------------------------------------------------------
    | Flash Port
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'flashPort'    => env('LATCHET_FLASH_PORT', 843),
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'zmqPushId' => env('LATCHET_ZMQ_PUSH_ID', 'latchet.push'),
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'zmqPullId' => env('LATCHET_ZMQ_PULL_ID', 'latchet.pull')
